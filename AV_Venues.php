...
<html lang="en" dir="ltr">
  <head>
  <title> Abram's Catering | Venues </title>

    <meta charset="utf-8">
    <link rel="stylesheet" href="AV_Abram's_Venues.css">
...
<div class="content">
  <div class="header">Looking for a perfect venue?</div>
  <p>With more than 300 venues to choose from where Abrams's Events Catering Services is accredited,</p>
  <p>  we are confident you will find the one that matches your needs. </p>
</div>

<div class="filter-container">
  <label for="event-type" class="select1">Filter Venue By:</label>
  ...
  <div class="select">
    ...
    <select name="venue-capacity" id="venue-capacity">
      <option value="volvo">Select Venue Capacity</option>
      <option value="saab">1</option>
      <option value="opel">2</option>
      <option value="audi">3</option>
    </select>
