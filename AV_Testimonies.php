...
<html lang="en" dir="ltr">
  <head>
  <title> Abram's Catering | Testimonies </title>

    <meta charset="utf-8">
    <link rel="stylesheet" href="AV_Abram's_Testimonies.css">
...
<div class="image-container top-image">
  ...
  <div class="text-overlay">
    ...
    <p> Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
      ...
      <!-- Container Row 1 (Containers 1-4) -->
      <div class="container-row">
        <!-- 4 Containers (Squares) in Row 1 -->
        <div class="container"> <!-- Container 1 -->
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 1">
        </div>
        ...
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 2">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
        ...
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 3">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
        ...
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 4">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
      </div> <!-- End of Container Row 1 -->
      
      <!-- Container Row 2 (Containers 5-8) -->
      <div class="container-row">
        <!-- 4 Containers (Squares) in Row 2 -->
        <div class="container"> <!-- Container 5 -->
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 5">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
        ...
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 6">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
        ...
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 7">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
        ...
        <div class="circle">
          <img src="AV_Testimonies_User.png" alt="Image 8">
        </div>
          <div class="star-rating">★★★★★</div>
        </div>
      </div> <!-- End of Container Row 2 -->
    </div> <!-- End of Container Wrapper -->

     <!-- WRITE A REVIEW Button -->
     <a href="Testimonies_Feedback.php" button class="write-review-btn">WRITE A REVIEW</button></a>
     <!-- BACK Button -->
