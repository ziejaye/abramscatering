...
if (isset($_GET['search'])) {
    $search = $_GET['search'];
    $sql = "SELECT * FROM virtual_meeting 
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['update'])) {
        ...
        $updateSql = "UPDATE virtual_meeting SET 
                        Name='$updatedName', 
    ...
    if (isset($_POST['delete'])) {
        ...
        $deleteSql = "DELETE FROM virtual_meeting WHERE id=$id";
...
<html lang="en" dir="ltr">
  <head>
    <title> Abram's Catering | Book Meeting </title>
    <meta charset="utf-8">
    <link rel="stylesheet" href="AV_BookMeeting.css">
...
<script>
    function showUpdateForm(id, button) {
        ...
        var contact = row.cells[1].innerText;
