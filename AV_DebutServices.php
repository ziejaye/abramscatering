  ...
  <head>
  <title> Abram's Catering | Debut </title>
    <link rel="shortcut icon" type="x-icon" href="AV_logo.png">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="AV_Debut_CS.css">
  ...
  <li><a href="AV_Contact_Us.php"> Contact Us </a></li>
    ...
    for (i = 0; i < li.length; i++) {
      ...
      <div class="image-container top-image">
        <img src="AV_Debut_CS2.png" alt="">
        <div class="text-overlay">
          <h1> Debut Catering Services </h1> 
          <p> Your Debut, Your Way - Where Dreams Begin, Memories Are Made. </p> 
        </div>
      </div>
